...
fn sort(mut name_of_process:Vec<String>, mut burst_time:Vec<i32>,number_of_processes:usize){
    for i in 0..number_of_processes{
...
fn main(){
    ...
    for i in 0..number_of_processes {
        ...
        let burst_value: i32 = burst.trim().parse().expect("Please enter a burst time of process:: ");
